...
MAP_FOCUS = (-122.3325139, 47.6119765)#Seattle

WORLD_MAP_FOCUS = 0.004 #Needed to handle the 50k node limit from OSM
...
# Using GPIO.BCM as mode
GPIO_ACTIONS = {
    13: "module_stats", #GPIO 33
    19: "module_items", #GPIO 35
    26: "module_data", #GPIO 37
    12: "knob_up", #GPIO 32
    16: "knob_down", #GPIO 36
    20: "dial_up", #GPIO 38
    21: "dial_down" #GPIO 40
}
